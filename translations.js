...
export const translations = {
    ...
    en: {
        ...
        'help.step1':  'Enter the <strong>Occupation Title</strong> and <strong>Job Title</strong> in the <em>Chart Info</em> tab.',
    ...
    ar: {
        ...
        'chartInfo.occupationTitle':     '💼 المسمى المهني:',
        'chartInfo.occupationTitle.ph':  'مثال: فني سيارات',
        'chartInfo.jobTitle':            '👔 المسمى الوظيفي:',
        ...
        'status.pdfMissingFields':'يرجى ملء المسمى المهني والمسمى الوظيفي على الأقل',
        ...
        'pdf.occupationTitle':   'المسمى المهني:',
        'pdf.jobTitle':          'المسمى الوظيفي:',
        ...
        'word.occupationTitle': 'المسمى المهني: {{title}}',
        'word.jobTitle':        'المسمى الوظيفي: {{title}}',
        ...
        'help.step1':  'أدخل <strong>المسمى المهني</strong> و<strong>المسمى الوظيفي</strong> في تبويب <em>معلومات المخطط</em>.',
